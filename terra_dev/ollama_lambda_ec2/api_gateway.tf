...
# --------------------
# We use the lightweight HTTP API flavor with Lambda proxy integrations (payload v2.0).
# POST /generate accepts requests asynchronously and GET /requests/{request_id} lets the
# caller poll the queued/processing/completed status.
